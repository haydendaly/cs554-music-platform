...
function UserProfile(props) {
  ...
  const submitForm = async(e) =>{
    ...
    try {
      const { data } = await axios.patch(`http://localhost:3000/api/user/${user._id}`, updateData);
      setUser(data);
  ...
  if(user && props.page === "ShowProfile"){
    body = (<div>
      ...
      <ul className="social-icons">
        ...
        (<li key="facebook"><a href={user.socialMedia.facebook} target="_blank" rel="noreferrer"><img
        src="/imgs/social_media_icon/Facebook.png" alt="facebook" /></a></li>) }
        {user.socialMedia.instagram === ""? null : 
        (<li key="instagram"><a href={user.socialMedia.instagram} target="_blank" rel="noreferrer"><img
        src="/imgs/social_media_icon/Instagram.png" alt="instagram" /></a></li>) }
        {user.socialMedia.twitter === ""? null : 
        (<li key="twitter"><a href={user.socialMedia.twitter} target="_blank" rel="noreferrer"><img
        src="/imgs/social_media_icon/Twitter.png" alt="twitter" /></a></li>) }
      </ul>
