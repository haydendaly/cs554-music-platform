...
function PostInsert() {
    ...
    return (
        <div className="main">
            ...
            <center> <button onClick={() => showAddPostModal()}>Add Post</button></center>
            </div>
            <br/> 
                ...
                {product.songData ?
                    ...
                    <Card className={classes.root}>
                        ...
                        <CardContent className={classes.content}>
                            <Typography component="h5" variant="h5">{product.songData.name}</Typography>
                            <Typography variant="subtitle1" color="textSecondary">{product.songData.id}</Typography>
                            <Typography variant="subtitle1" color="textSecondary">
                                <a href={product.songData.href}>{product.songData.href}</a> 
                            </Typography>
                            <iframe id="playSong" src= {"https://open.spotify.com/embed?uri="+ product.songData.uri}
