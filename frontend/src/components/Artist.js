   ...
   //https://open.spotify.com/album/5Ouuxga807CPAs81lSloBJ?si=u9qkqNpiR2m45FkvcG4rnQ
            ...
            <Grid item xs={12} sm={6} md={4} lg={4} xl={2} key={artist.id}>
                <Card className={classes.card} variant="outlined">
                    ...
                    <iframe
                        id="playSong"
                        src={
                            'https://open.spotify.com/embed?uri=' + artist.uri
                        }
                        width="300"
                        height="380"
                        frameborder="0"
    ...
    if (loading) {
        ...
        return (
            <div class="main">
            <div class = "row">
            <div class="col-md-3 col-sm-6 col-xs-12" className={classes.sidebar}>
            <div className={classes.sidebarCard}>
            <h4>Artist List</h4>
            <Card variant='outlined'>
            <CardActionArea>
            <Link onClick={() => getAtristID('2CIMQHirSU0MQqyYHq0eOx')}>
                <CardMedia
            ...
            <Card  variant='outlined'>
            <CardActionArea>
            <Link onClick={() => getAtristID('53A0W3U0s8diEn9RhXQhVz')}>
                <CardMedia
                className={classes.media}
                component='img'
                image={Keane_Image}
            ...
            <Card variant='outlined'>
            <CardActionArea>
            <Link onClick={() => getAtristID('1vCWHaC5f2uS3yhpwWbIA6')}>
                <CardMedia
                className={classes.media}
                component='img'
                image={Avici_Image}
            ...
            <Card variant='outlined'>
            <CardActionArea>
            <Link onClick={() => getAtristID('43ZHCT0cAZBISjO8DG9PnE')}>
                <CardMedia
                className={classes.media}
                component='img'
                image={Elvis_Image}
            ...
            <Card variant='outlined'>
            <CardActionArea>
            <Link onClick={() => getAtristID('57dN52uHvrHOxijzpIgu3E')}>
                <CardMedia
                className={classes.media}
                component='img'
